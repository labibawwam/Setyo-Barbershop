...
<body class="bg-slate-50 text-slate-800 antialiased selection:bg-indigo-500 selection:text-white">
    ...
    <section id="kapster" class="py-24 relative bg-white overflow-hidden">
        <div class="absolute top-0 left-1/4 w-[500px] h-[500px] bg-indigo-500/5 blur-[120px] pointer-events-none"></div>
        <div class="absolute bottom-0 right-0 w-[350px] h-[350px] bg-indigo-200/5 blur-[100px] pointer-events-none"></div>

        <div class="max-w-[1440px] mx-auto px-6 relative z-10">
            <div class="flex flex-col items-center text-center mb-16">
                <div class="inline-block">
                    <p class="text-indigo-600 font-black uppercase tracking-[0.4em] text-[9px] mb-3">
                ...
                <h2 class="font-display text-4xl md:text-6xl font-bold text-slate-900 leading-tight tracking-tight">
                    Master <span class="text-indigo-600 italic font-serif font-light">Groomers</span>
                </h2>
            </div>
            ...
            <div class="relative w-full overflow-hidden group/container" style="mask-image: linear-gradient(to right, transparent, black 15%, black 85%, transparent);">
                <div class="flex gap-5 loop-track group-hover/container:pause-animation">
                    ...
                    <div class="flex-none w-[200px] md:w-[240px]" aria-hidden="true">
                        <div class="group relative overflow-hidden rounded-[2.5rem] aspect-[4/5] border border-slate-200 bg-white transition-all duration-700 hover:border-indigo-400/40 hover:-translate-y-2 shadow-lg">
                            ...
                            <div class="absolute bottom-8 left-0 right-0 px-6 text-center">
                                ...
                                <h3 class="text-xl font-bold text-slate-900 tracking-tight leading-none">{{ $kps->nama }}</h3>
                            </div>
                        </div>
                    </div>
                    @endforeach
        ...
        <div class="max-w-[1440px] mx-auto px-6 relative z-10">
            ...
            <div class="flex flex-wrap justify-center gap-6 md:gap-12 mb-20">
                @foreach ($categories as $index => $category)
                    ...
                    <div class="h-[2px] w-0 bg-indigo-500 rounded-full transition-all duration-500 group-[.active-tab]:w-full shadow-[0_0_10px_rgba(99,102,241,0.4)]"></div>
                </button>
                @endforeach
            </div>
            ...
            <div id="services-container">
                ...
                <div id="cat-{{ $category->id }}" class="category-content {{ $index == 0 ? 'block' : 'hidden' }} animate-fade-in">
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 items-stretch">
                        ...
                        <div class="group relative bg-white border border-slate-200 rounded-[2.5rem] p-5 transition-all duration-700 hover:border-indigo-300 hover:-translate-y-3 flex flex-col shadow-sm hover:shadow-xl">

                            <div class="relative overflow-hidden rounded-[2rem] h-64 mb-6 shadow-md flex-shrink-0">
                            ...
                            <div class="px-2 pb-2 flex flex-col flex-grow">
                                <h3 class="text-xl font-bold text-slate-900 tracking-tight group-hover:text-indigo-600 transition-colors mb-3">
                                    {{ $srv->nama_service }}
                                </h3>

                                <p class="text-slate-500 text-xs leading-relaxed mb-8 font-light italic">
                                    {{ $srv->deskripsi }}
                                </p>
                                ...
                                <div class="flex items-center justify-between border-t border-slate-100 pt-5 mt-auto">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-[10px] text-slate-400 font-bold uppercase tracking-[0.2em]">{{ $srv->durasi }} Mins Session</span>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section id="contact" class="py-32 bg-slate-50 relative overflow-hidden">
        <div class="absolute top-1/2 left-0 w-[500px] h-[500px] bg-indigo-500/5 blur-[150px] -z-10"></div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-16 items-start">
                ...
                <div class="lg:col-span-1">
                    <div class="inline-block mb-4">
                        <p class="text-indigo-600 font-black uppercase tracking-[0.4em] text-[10px]">Find Our Studio</p>
                        <div class="h-[1px] w-12 bg-indigo-500 mt-2"></div>
                    </div>

                    <h2 class="font-display text-5xl md:text-6xl font-bold text-slate-900 mb-10 leading-tight">
                        Get in <br><span class="text-gradient italic">Touch</span>
                    </h2>
                    ...
                    <div class="space-y-12">
                        <a href="https://maps.google.com/?q=Setyo+Barbershop+Delanggu" target="_blank" class="flex items-start space-x-6 group cursor-pointer">
                            <div class="w-14 h-14 shrink-0 rounded-2xl bg-white border border-slate-200 flex items-center justify-center group-hover:bg-indigo-600 group-hover:border-indigo-500 transition-all duration-500 group-hover:-translate-y-2 shadow-sm group-hover:shadow-indigo-100">
                            ...
                            <div>
                                <p class="text-slate-400 text-[10px] uppercase tracking-[0.3em] font-black mb-1">Our Location</p>
                                <p class="text-slate-800 text-lg font-medium leading-relaxed group-hover:text-indigo-600 transition-colors">Jl. Lkr. Delanggu, Krecek,<br>Kab. Klaten, Jawa Tengah</p>
                            </div>
                        </a>

                        <div class="flex items-start space-x-6 group">
                            <div class="w-14 h-14 shrink-0 rounded-2xl bg-white border border-slate-200 flex items-center justify-center group-hover:bg-indigo-600 group-hover:border-indigo-500 transition-all duration-500 group-hover:-translate-y-2 shadow-sm">
                                <svg class="w-6 h-6 text-indigo-500 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 8v4l3 2m6-2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg>
                            </div>
                            <div class="flex-grow">
                                <p class="text-slate-400 text-[10px] uppercase tracking-[0.3em] font-black mb-5">Operating Hours</p>

                                <div class="space-y-3.5 w-full max-w-[260px]">
                                    <div class="flex justify-between items-center group/day">
                                        <span class="text-xs font-bold text-slate-500 group-hover/day:text-slate-700 transition-colors">Senin</span>
                                        <span class="text-[9px] font-black text-red-500 uppercase tracking-widest bg-red-50 px-3 py-1 rounded-lg border border-red-100">Tutup / Libur</span>
                                    </div>
                                    ...
                                    @foreach($days as $day)
                                    <div class="flex justify-between items-center group/day border-t border-slate-200 pt-3.5">
                                        <span class="text-xs font-bold text-slate-500 group-hover/day:text-slate-900 transition-colors">{{ $day }}</span>
                                        <span class="text-[11px] font-mono font-bold text-slate-700 group-hover/day:text-indigo-600 transition-colors">10:00 — 21:00</span>
                                    </div>
                                    @endforeach

                                    <div class="mt-5 pt-4 border-t border-indigo-100 flex items-center gap-2">
                                        <div class="w-1 h-1 rounded-full bg-indigo-500 animate-pulse"></div>
                                        <p class="text-[8px] text-indigo-400 font-black uppercase tracking-[0.2em]">WIB — Waktu Indonesia Barat</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <a href="tel:085641728429" class="flex items-start space-x-6 group cursor-pointer">
                            ...
                            <div>
                                <p class="text-slate-400 text-[10px] uppercase tracking-[0.3em] font-black mb-1">Make a Call</p>
                                <p class="text-slate-900 text-2xl font-bold tracking-tighter group-hover:text-indigo-600 transition-colors">0856 4172 8429</p>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="lg:col-span-2 relative group h-full self-stretch">
                    <div class="absolute -inset-1 bg-indigo-500 rounded-[2.5rem] blur opacity-5 group-hover:opacity-10 transition duration-1000"></div>

                    <div class="relative rounded-[2.5rem] overflow-hidden border border-slate-200 h-[600px] lg:h-full min-h-[500px] shadow-xl bg-white">
                        <iframe
                        ...
                        <div class="absolute bottom-8 left-8 right-8 p-6 backdrop-blur-md bg-white/80 border border-slate-200 rounded-3xl flex items-center justify-between opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-700">
                            ...
                            <a href="https://maps.google.com/?q=Setyo+Barbershop+Delanggu" target="_blank" class="px-7 py-3 bg-indigo-600 text-white text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-slate-900 transition-all shadow-lg active:scale-95">Open in Maps</a>
                        </div>
                    </div>
                </div>
