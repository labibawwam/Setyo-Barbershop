                    ...
                    <div class="flex items-center gap-4 min-w-0">
                        <div class="min-w-0">
                            <h1 class="text-2xl md:text-3xl font-black text-slate-900 tracking-tight flex items-center gap-3">
                                Work <span class="text-indigo-600 italic font-serif text-xl md:text-2xl font-normal lowercase tracking-normal">shifts</span>
                            </h1>
                    ...
                    <table class="w-full text-left border-separate border-spacing-y-3 min-w-[800px]">
                        <thead class="sticky top-0 z-20 bg-[#f8fafc]/95 backdrop-blur-sm">
                            <tr class="text-[10px] font-black text-slate-400 uppercase tracking-[0.25em]">
                                <th class="py-4 px-6 border-b border-slate-200 w-[30%]">Kapster Artist</th>
                                <th class="py-4 px-6 border-b border-slate-200 w-[15%]">Day</th>
                                <th class="py-4 px-6 border-b border-slate-200 w-[25%]">Time Window</th>
                                <th class="py-4 px-6 border-b border-slate-200 w-[15%] text-center">Status</th>
                                <th class="py-4 px-6 border-b border-slate-200 text-right w-[15%]">Actions</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-transparent">
                            @foreach($kapsters as $kapster)
                                ...
                                <tr class="group transition-all duration-500">
                                    ...
                                    <td class="py-4 px-6 bg-white group-hover:bg-slate-50 border-y border-slate-200 shadow-sm">
                                        @if($shift->is_libur)
                                            <span class="text-[10px] text-slate-300 italic font-black tracking-widest">— CLOSED —</span>
                                        @else
